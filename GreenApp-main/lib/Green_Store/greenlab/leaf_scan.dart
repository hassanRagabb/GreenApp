...
//       return 'lib/Green_Store/greenlab/models/Apple';
//     } else if (modelName.toLowerCase() == "bellpepper") {
//       return 'lib/Green_Store/greenlab/models/BellPepper';
//     } else if (modelName.toLowerCase() == "cherry") {
//       return 'lib/Green_Store/greenlab/models/Cherry';
//     } else if (modelName.toLowerCase() == "corn") {
//       return 'lib/Green_Store/greenlab/models/Corn';
//     } else if (modelName.toLowerCase() == "grape") {
//       return 'lib/Green_Store/greenlab/models/Grape';
//     } else if (modelName.toLowerCase() == "peach") {
//       return 'lib/Green_Store/greenlab/models/Peach';
//     } else if (modelName.toLowerCase() == "potato") {
//       return 'lib/Green_Store/greenlab/models/Potato';
//     } else if (modelName.toLowerCase() == "rice") {
//       return 'lib/Green_Store/greenlab/models/Rice';
//     } else if (modelName.toLowerCase() == "tomato") {
//       return 'lib/Green_Store/greenlab/models/Tomato';
//     } else if (modelName.toLowerCase() == "flowers") {
//       return 'lib/Green_Store/greenlab/models/Flowers';
//     } else {
//       return "";
//     }
//   }
...
//                         )
//                       : LottieBuilder.asset(
//                           'lib/Green_Store/greenlab/assets/39771-farm.json',
//                           width: 300,
//                           height: 300,
//                         ),
//                 ),
